...
$extraInfo['lang']                 = 'en';
$track = $track->createTracking('qfkd','RP325552475CN',$extraInfo);
...
//$track = $track->getSingleTrackingResult("qfkd","RP325552475CN",'en');
...
//$extraInfo['destination_code'] = 'US';
//$extraInfo['status']       = '7';
//$track = $track->updateTrackingItem('qfkd','RP325552475CN',$extraInfo);

//8 Delete a tracking item (删除单个运单号)
//$track = $track->deleteTrackingItem('qfkd','RP325552475CN');

//9 Get realtime tracking results of a single tracking (获取单个运单号实时物流信息)
// $track = $track->getRealtimeTrackingResults("qfkd","RP325552475CN",array("lang"=>'en'));

//10 Modify courier code (修改运输商简码)
//$r = $track->updateCarrierCode("RP325552475CN","qfkd","china-ems");
...
//$date = array();
//$data[] = array("tracking_number"=>"RP325552475CN","carrier_code"=>"qfkd");
...
//$data = array();
//$data[] = array("original"=>"CN","destination"=>"US","carrier_code"=>"qfkd");
